...
public class CourseModel: ObservableObject {
    ...
    /// Note: Now semester start dates are directly obtained from the academic system, so this function does nothing.
    public func receiveUndergraduateStartDateContextUpdate(startDateContext: [Int: Date]) {
        // Semester start dates are now directly obtained from the academic system
